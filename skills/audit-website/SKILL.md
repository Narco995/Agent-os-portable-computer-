...
--format <fmt>
-f <fmt>
Output format: console, text, json, html, markdown, llm
console
...
--max-pages <n>
-m <n>
Maximum pages to crawl (max 5000)
varies by coverage
...
quick
25
Seed + sitemaps only, no link discovery
CI checks, fast health check


surface
100
One sample per URL pattern
General audits (default)


full
500
Crawl everything up to limit
Deep analysis
