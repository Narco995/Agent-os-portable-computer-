...
B2B SaaS
Setup wizard → First value action → Team invite → Deep setup
...
Mobile App
Permissions → Quick win → Push setup → Habit loop


Content Platform
Follow/customize → Consume → Create → Engage
